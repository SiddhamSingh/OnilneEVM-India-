	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>OnilneEVM(India)</h2>
				<p>Your Vote is Our Priority</p>
				<br><br>
				<center>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>OnilneEVM(India)</h2>
						<p>Explore the new way of Voting...</p>
					</header>
					<div class="row 200%">
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">OnilneEVM(India) &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">Your Vote is Our Priority !!!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">OnilneEVM(India) Fam<span>Vormir</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:siddhamrao2002@gmail.com" style="color:white">demo@demo.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About OnilneEVM(India)</b></span>
				OnilneEVM(India) is online voting platform for Elections & Basic Voting...
			</p>
								...
								<div class="row uniform 50%">
									...
									<div class="row uniform">
				                        ...
				                        <div class="3u 12u$(small)">
				                            ...
				                            <label for="farmer">Party Member</label>
				                        </div>
				                        <div class="3u 12u$(small)">
				                            <input type="radio" id="buyer" name="category" value="0">
				                            <label for="buyer">Voter</label>
				                        </div>
									</div>
									<center>
									<div class="row uniform">
