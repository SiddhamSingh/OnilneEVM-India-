...
<html>
<head>
	<title>OnilneEVM(India): Product</title>
	<meta lang="eng">
	<meta charset="UTF-8">
...
<body>
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-12 col-sm-6">
									...
									<p style="font: 30px Times new roman;">Candidate Name : <?= $frow['fname']; ?></p>
									<p style="font: 30px Times new roman;">Rating : <?= $row['price'].' /-'; ?></p>
								</div>
							</div><br />
							<div class="row">
			...
			?>
			<div class="container">
				<p style="font: 20px Times new roman; align: left;">Rate this Candidate</p>
