			...
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<form method="POST" action="uploadProduct.php" enctype="multipart/form-data">
						<h2>Enter the Candidate Information here..!!</h2>
						<br>
				<center>
					  ...
					  <div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto" >
							  <select name="type" id="type" required style="background-color:white;color: black;">
								  ...
								  <option value="Fruit" style="color: black;">BJP</option>
								  <option value="Vegetable" style="color: black;">INC</option>
								  <option value="Grains" style="color: black;">AJP</option>
							  </select>
						</div>
					  </div>
					  <div class="col-sm-6">
